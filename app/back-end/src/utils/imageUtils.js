...
const bucketName = process.env.BUCKET_NAME_3;
const bucketRegion = process.env.BUCKET_REGION_3;
const accessKey = process.env.ACCESS_KEY_3;
const secretAccessKey = process.env.SECRET_ACCESS_KEY_3;
