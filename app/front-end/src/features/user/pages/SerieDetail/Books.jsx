...
function Books() {
  return (
    <div>
      <p className='font-poppins font-semibold text-2xl mt-8 md:mt-0 2xl:w-full 2xl:text-center'>
        Harry Potter series books:
      </p>
      <div className='2xl:grid 2xl:grid-cols-2 gap-x-4'>
        {[...Array(8)].map((_, index) => (
          <div key={index} className='flex space-x-2 mt-4 pb-4 border-b'>
            <img
              src={harryPotter1}
              alt='book image'
