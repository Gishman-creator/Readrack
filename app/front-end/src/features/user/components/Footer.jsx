...
function Footer() {
    return (
        <div className=' px-[4%] sm:px-[12%]'>
            <div className='flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 border-t border-gray-300 pt-4'>
                ...
                <div className='flex font-semibold text-gray-400 space-x-4'>
            ...
            <span className='block py-2 text-xs text-center font-bold text-gray-500 mt-4 sm:mt-0'>© 2024 readrack. All Rights Reserved.</span>
        </div>
    )
}
