...
exports.insertNewSerie = async (serieName, authorId) => {
    ...
    const insertSerieQuery = `INSERT INTO series (id, serie_name, author_id) VALUES ($1, $2, $3)`;
    await poolpg.query(insertSerieQuery, [serieId, serieName, authorId]);
};
